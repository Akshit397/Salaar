...
const sellerCategoriesListingStages = [
    ...
    {
        $project: {
            _id: 1, createdAt: 1, registerId: 1, "category._id": 1, "category.categoryName": 1,
            "subCategory._id": 1, "subCategory.categoryName": 1,
            "childCategory._id": 1, "childCategory.categoryName": 1,
            "seller._id": 1, "seller.fullName": 1, image: 1, status: 1, approvalStatus: 1
        }
    }
]
   ...
   ********************************************************/
    async getSellerCategories() {
        try {
            ...
            const sellerCategories = await SellerCategories.findOne({ _id: data.sellerCategoryId, isDeleted: false }, { _v: 0 })
